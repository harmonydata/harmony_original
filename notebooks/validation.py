...
def validate(validation_data, match_function, MODEL_NAME):
    short_model_name = re.sub(r':.+', '', MODEL_NAME.split("\n")[0])
    ...
    with open("log.txt", "a") as log_file:
        for dataset, dataset_data in validation_data.items():
            ...
            for questionnaire in dataset_data:
                ...
                if ("PT" in dataset and not "EN" in dataset) or "Sentir" in questionnaire[0][0]:
            ...
            log_file.write(f'{short_model_name}\t{dataset}\t{roc_auc*100:0.2f}\n')
        ...
        plt.savefig(f'output/{short_model_name}.png',dpi=300, bbox_inches = "tight")
