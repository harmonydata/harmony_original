...
# Token.set_extension("is_sequential_bullet", default=False)
...
# def get_preceding_sequential_bullet_value(span):
#     for i in range(span.start + 1, span.start - 3, -1):
#         if i >= span.end:
#             continue
#         if i >= 0 and i < len(span.doc):
#             if span.doc[i]._.is_sequential_bullet:
#                 return span._.preceding_bullet_value
#     return None


# Span.set_extension("preceding_sequential_bullet_value", getter=get_preceding_sequential_bullet_value)
...
for model in ["en_core_web_sm", "pt_core_news_sm"]:
    ...
    language_to_model[nlp.lang] = nlp
